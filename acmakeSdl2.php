...
$sdl_installed = shell_exec("dpkg -s libsdl2-dev | grep Status");

if (strpos($sdl_installed, "install ok installed") === false) {
    // SDL2 is not installed, download and install it
    echo "SDL2 is not installed on your system.\n";
    echo "Downloading and installing SDL2...\n";
    shell_exec("sudo apt-get update -y");
    shell_exec("sudo apt-get install libsdl2-dev -y");
}
